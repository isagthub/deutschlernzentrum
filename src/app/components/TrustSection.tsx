          ...
          <div className="flex flex-col gap-8 reveal-left">
            <div>
              ...
              <p className="mt-4 text-lg text-muted-foreground leading-relaxed max-w-lg">
                Unser Team besteht ausschließlich aus Lehrkräften, die Deutsch auf muttersprachlichem Niveau beherrschen, als Sprachlehrkräfte zertifiziert sind und Erfahrung in der Jugend- und Erwachsenenlehre haben.
              </p>
            </div>
